...
if ./is_running.sh | grep -q "ue$UE_NUMBER"; then
    ...
    sudo ip netns exec ue$UE_NUMBER ./nr-uesoftmodem -O "../../../../configs/ue$UE_NUMBER.conf" --rfsim --rfsimulator.serveraddr $HOSTNAME_IP --rfsimulator.options chanmod -r 106 --numerology 1 --band 78 -C 3619200000
fi
